...
export function itemListMarkup(items = [], { context = 'database', groups = [] } = {}) {
  return `<div class="kiosko-list unified-list" role="table">
    <div class="kiosko-list__row kiosko-list__row--head" role="row"><span aria-label="Carátula"></span><span>Título</span><span>Fuente</span><span>Tipo</span><span>Estado</span><span>Rating</span><span>Fecha</span></div>
    ${items.map(item => {
