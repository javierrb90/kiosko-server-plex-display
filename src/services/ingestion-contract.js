...
export function normalizeIngestionPayload(payload = {}) {
  ...
  return {
    ...
    title,
    ...(Object.prototype.hasOwnProperty.call(payload, "subtype") ? { subtype: clean(payload.subtype) || null } : {}),
    ...(Object.prototype.hasOwnProperty.call(payload, "context") ? { context: clean(payload.context) || null } : {}),
    ...(Object.prototype.hasOwnProperty.call(payload, "detail") || Object.prototype.hasOwnProperty.call(payload, "subtitle") ? { detail: clean(payload.detail ?? payload.subtitle) || null } : {}),
    eventType,
